...
pub fn run(
    ...
    info!("Job 'compact' starting.");
    let can_tok = cancellation_token.clone();
    let runtime_inner = runtime.clone();

    let join_handle = runtime.spawn(async move {
        info!("Job 'compact' started.");
    ...
    BackgroundTask::new("compact".to_string(), join_handle, true)
}
